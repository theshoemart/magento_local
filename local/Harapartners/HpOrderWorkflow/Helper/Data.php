 ...
 * 
 */
class Harapartners_QuietLogistics_Helper_Data extends Mage_Core_Helper_Abstract {
	
    const ORDER_STATUS_SENT = 'quietlogistics_sent';
    const ORDER_STATUS_SENT_FAILED = 'quietlogistics_sent_failed';
